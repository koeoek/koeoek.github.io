...
level4.prototype = {
    ...
    create: function() {
        ...
        this.pills.create(822, 784, 'pill');
        this.pills.create(1849, 880, 'pill');
        this.pills.create(2368, 848, 'pill');
        this.pills.create(3631, 880, 'pill');
        this.pills.create(4881, 880, 'pill');
        this.pills.create(5248, 784, 'pill');
